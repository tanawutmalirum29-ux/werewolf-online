...
assert(server.includes('payload.admin === true'), 'admin session must carry an explicit signed admin marker');
...
assert(admin.includes('credentials:"same-origin"'), 'admin password login must send same-origin cookie credentials');
